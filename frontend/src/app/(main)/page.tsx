  ...
  return (
    <main>
      ...
      <section className="relative w-full h-[921px] min-h-[700px] flex flex-col justify-center items-center pt-[72px]">
        ...
        <div className="relative z-10 text-center px-margin-mobile md:px-margin-desktop w-full max-w-container-max mx-auto flex flex-col items-center">
          <h1 className="font-display-lg-mobile md:font-display-lg text-white mb-6 max-w-3xl drop-shadow-lg">
            Discover the Untamed Beauty of Maharashtra
          </h1>
          <p className="font-body-lg text-white/90 mb-12 max-w-2xl drop-shadow-md">
            Curated expeditions, verified professional guides, and safety-first adventures across the Sahyadris.
          </p>
          
          {/* Glassmorphism Search Bar */}
          <div className="bg-white/20 backdrop-blur-xl border border-white/30 rounded-full p-2 w-full max-w-4xl flex flex-col md:flex-row items-center gap-2 shadow-2xl">
      ...
      <section className="py-24 bg-surface-off-white px-margin-mobile md:px-margin-desktop">
        <div className="max-w-container-max mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-gutter h-auto md:h-[600px]">
            ...
            <Link href="/adventures/harishchandragad" className="md:col-span-2 md:row-span-2 relative rounded-xl overflow-hidden group ambient-shadow cursor-pointer min-h-[400px]">
            ...
            <Link href="/adventures/pawna-kayaking" className="md:col-span-2 md:row-span-1 relative rounded-xl overflow-hidden group ambient-shadow cursor-pointer min-h-[280px]">
            ...
            {/* Small Features */}
            <div className="md:col-span-1 md:row-span-1 relative rounded-xl overflow-hidden bg-surface ambient-shadow p-6 flex flex-col justify-between border border-outline-variant/20">
              <div>
              ...
              <Link href="/guides" className="text-primary font-label-md text-label-md mt-4 hover:underline">
                Meet the team
              </Link>
            </div>

            <div className="md:col-span-1 md:row-span-1 relative rounded-xl overflow-hidden bg-primary text-white ambient-shadow p-6 flex flex-col justify-center items-center text-center">
              ...
              <button className="border border-white text-white px-6 py-2 rounded-xl font-label-md text-label-md hover:bg-white hover:text-primary transition-colors w-full">
                Inquire Now
              </button>
            </div>
          </div>
